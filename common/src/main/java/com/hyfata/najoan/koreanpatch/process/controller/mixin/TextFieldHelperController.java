...
public class TextFieldHelperController implements IMixinCommon {
    ...
    public boolean onBackspaceKeyPressed() {
        return MixinCommonController.onBackspaceKeyPressed(this, getCursor(), this.getText());
    }
    ...
    public boolean onHangulCharTyped(int keyCode, int modifiers) {
        ...
        return MixinCommonController.onHangulCharTyped(this, keyCode, modifiers, text, accessor.selectedText(text).isEmpty());
    }
